...
- From the box labeled **LCD Display** you will need the following
	...
	- a small screwdriver
	- two 3D printed legs
	- a bag with 4 chrome screws, 4 gold-colored threaded stand
	  offs, and two black screws

![LCD Display Components](/images/lcd-display-1.jpeg)
...
![Components Bag and Wifi Dongle](/images/components-bag-1.jpeg)
...
![Gold standoffs attached to screen](images/standoffs-2.jpeg)
...
![Potato attached to screen](images/potato-1.jpeg)

5. Attach the HDMI component labeled **H-3B** and the USB component
labeled **USB-H 3B**

![Before attaching HDMI and USB components](images/connectors-1.jpeg)

![After attaching HDMI and USB components](images/connectors-2.jpeg)

#### Attaching the Legs

6. Attach the display's **legs** as pictured using the black screws.

![Attached legs](images/legs.jpeg)
...
![Before plugging in](images/sd-1.jpeg)

![After pluggin in](images/sd-2.jpeg)
...
![Wifi Attached](images/wifi-1.jpeg)
...
4. Add the following to the file below or replacing the existing network
configuration. Be sure to replace `abc123` and `GoDogs!` with your
...
6. Type `reboot` into the terminal and hit `Enter`
