...
Figure @fig-argreturn should help clarify some of the terminology that
...
designer of the subprogram should anticipate the reception of these
arguments and will typically have a variable place holder for those
arguments.
...
# Once the function is defined, the USER of the function is now in
...
give back to the user of the subprogram. These values are typically the
result of some kind of calculation or process. You will find return
statements at the end of a subprogram. The user of a subprogram should
anticipate the reception of a return value by either storing it in a
variable or using the value as part of an expression.
